...
## Release History
 * 2015-02-14    v0.4.4    [Fix] [#19](https://github.com/charliedowler/gulp-flowtype/issues/19) Reset passed value when finished + [#20](https://github.com/charliedowler/gulp-flowtype/issues/20) handle execFile error
